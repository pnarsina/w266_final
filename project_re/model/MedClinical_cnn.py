...
# For i2b2
    ...
    def in_features_fc(self):
      ...
      out_conv_1 = ((self.layer1_features - 1 * (self.kernel_1 - 1) - 1) / self.stride) + 1
      #((768 - 1*(2-1) -1)/2) + 1 = 384
      ...
      out_conv_2 = ((self.layer1_features - 1 * (self.kernel_2 - 1) - 1) / self.stride) + 1
      #((768 - 1*(4-1) -1)/2) + 1 = 383
      ...
      out_conv_3 = ((self.layer1_features - 1 * (self.kernel_3 - 1) - 1) / self.stride) + 1
      #((768 - 1*(6-1) -1)/2) + 1 = 382
...
class Biobert_fc(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv_1 = nn.Conv1d(self.model_conf.layer1_features, self.model_conf.layer1_features, self.model_conf.kernel_1, self.model_conf.stride)
        self.conv_2 = nn.Conv1d(self.model_conf.layer1_features, self.model_conf.layer1_features, self.model_conf.kernel_2, self.model_conf.stride)
        self.conv_3 = nn.Conv1d(self.model_conf.layer1_features, self.model_conf.layer1_features, self.model_conf.kernel_3, self.model_conf.stride)
